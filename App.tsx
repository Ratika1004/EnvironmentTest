  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.greeting}>Hello, I'm Ratika!</Text>
        <Text style={styles.info}>Student ID: N01720136</Text>
        <Text style={styles.info}>Program: Computer Programming (CPAN)</Text>
